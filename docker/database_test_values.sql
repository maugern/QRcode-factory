...
INSERT INTO users (id, name, alias, email, passwdHash) VALUES (DEFAULT, 'Homer Simpson','homer','homer@simpson.com','$2y$10$ayzQ.6lOmS265diM3Zb2kezgCegNAw2iQynAys3pgS9FyKjDTJ9om');
INSERT INTO users (id, name, alias, email, passwdHash) VALUES (DEFAULT, 'Dark Vador','annie','vador@start.com','$2y$10$zy5SpQ9qTDymfvgvDmXBce6.u9AY8UYWPI87TOaXNaPBn8.C7AjY.');
